...
public class EditDescriptionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final CalendarCell cell = (CalendarCell) getIntent()
				.getSerializableExtra("cell");
		...
		this.saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				String description = EditDescriptionActivity.this.dayDescriptionEditText
						.getText().toString();
		...
		this.editTitleTextView.setText(String.format("%d年%d月%d日: ",
				cell.getYear(), cell.getMonth() + 1, cell.getDay()));
